                ...
                <div class="topbar-top d-flex justify-content-between flex-lg-wrap">
                    <div class="top-info flex-grow-0">
                        ...
                        <div class="pe-2 me-3 border-end border-white d-flex align-items-center">
                            <p class="mb-0 text-white fs-6 fw-normal">On Top News</p>
                        </div> -->
                        ...
                        <div class="d-flex flex-nowrap border-top pt-3 pt-xl-0 mx-2">
                            <div class="d-flex">
                                ...
                                <div class="d-flex align-items-center">
                                    <strong class="fs-4 text-danger">AMPAH NEWS</strong>
                                    <!-- <div class="d-flex flex-column ms-2" style="width: 150px">
                                        <span class="text-body">NEWS</span> -->
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-6 col-xl-3">
                <div class="footer-item-1">
                    ...
                    <p class="text-secondary line-h">
                        Address: <span class="text-white">Jln.Muwardi</span>
                    </p>
                    <p class="text-secondary line-h">
                        Email: <span class="text-white">ampahnews@gmail.com</span>
                    </p>
                    <p class="text-secondary line-h">
                        Phone: <span class="text-white">+6281346130415</span>
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-xl-3"> 
                <div class="footer-item-2">
                    ...
                    @foreach (\App\Models\News::where('status', 'Accept')->latest()->take(2)->get() as $news)
                        <a href="{{ route('news.viewCategory', $news->category->id) }}">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="d-flex flex-column ps-3">
                                    <p class="text-uppercase text-white mb-1">{{ $news->category->name }}</p>
                                    <a href="{{ route('news.show', $news->id) }}" class="h6 text-white">
                                        {{ $news->title }}
                                    </a>
                                    <small class="text-white"><i class="fas fa-calendar-alt me-1"></i>
            ...
            <div class="col-lg-6 col-xl-3">
                <div class="d-flex flex-column text-start footer-item-3">
                    <h4 class="mb-4 text-white">Popular Categories</h4>
                    @foreach (\App\Models\Category::orderBy('views', 'desc')->take(6)->get() as $category)
                        <a class="btn-link text-secondary mb-2" href="{{ route('news.viewCategory', $category->id) }}">
                            <i class="fas fa-angle-right text-primary me-2"></i>{{ $category->name }}
                        </a>
                    @endforeach
                </div>
            </div>

            <!-- Optional: Add another section here if needed -->
            <div class="col-lg-6 col-xl-3">
                <div class="footer-item-4">
                    <h4 class="mb-4 text-white">About</h4>
                    <p class="text-secondary">
                        Ampah News adalah portal berita digital terpercaya yang menyajikan informasi terkini dari berbagai kategori.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                <span class="text-light">
                    <a href="#" class="text-light"><i class="fas fa-copyright me-2"></i>Ampah News</a>,
                    All rights reserved.
                </span>
            </div>
